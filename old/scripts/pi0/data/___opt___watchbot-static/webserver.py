...
class WebServerApp (Thread) : 
    ...
    def __init__ (self, camerawrapper, telegrambot) :
        Thread.__init__(self)
        self.daemon=True
        self.app = tornado.web.Application(
            [   (r"/websocket", StreamHandler, {'camerawrapper' : camerawrapper, 'telegrambot':telegrambot}),
...
class StreamHandler (WebSocketHandler) : 
    ...
    def initialize(self, camerawrapper, telegrambot, **kwargs) : 
    ...
    def _start_stream (self) : 
        ...
        self.telegrambot.msg("Video stream is being accessed")
