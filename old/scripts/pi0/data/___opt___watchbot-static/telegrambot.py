...
class NotifyBot : 
    ...
    def msg (self, strmsg, sendto=None) : 
        if sendto is None : 
            sendto = self.registered
        for r in sendto : 
            self.bot.send_message(chat_id=r["conv"], text=strmsg)        
